...
# sys.path.append(r"/data/hinny/Scorpio_1.5_result/tool_codes/")
# sys.path.append(r"C:\Users\hinhi\OneDrive - HKUST Connect\MPhil\Scorpio_tool_codes\Scorpio_1.5\src")
from unit_conversion import time_Myrs_to_code, time_code_to_Myrs, extinction_mag_to_column_denisty_Msun_per_pc2, b_code_to_muG, number_den_H2_per_cm2_to_column_den_Msun_per_pc2
from mcf_project.calc_projection import fibonacci_sphere, rotate_3d, calcComponentsWeighted, calcStoke, connectedStructure, calcMCF, calcMCFSlopeAndArea, cartToSph, calcStoke_Phi
import math
...
if __name__=="__main__":
    ...
    n_rand = 10000 # number of projection directions
    x_rand_, y_rand_, z_rand_ = fibonacci_sphere(n_rand)
